import CssClass from "../Css/Search.module.css";
  ...
  return (
    <div className="relative pt-[24px] pb-[5px]">
      ...
      <div className="relative flex flex-col justify-center items-center">
        <p className="font-[700] text-white text-[24px] leading-[31px] text-center">
          HOTELS, RESORTS, HOSTELS & MORE
        </p>
        <p className="font-[400] text-white text-[20px] leading-[26px] text-center">
          Get the best prices on 2,000,000+ properties, worldwide
        </p>

        <div className=" relative z-[10] flex bg-white shadow-xl px-[64px] text-grey rounded-[8px] mt-[24px]">
          <Link
            to="/"
            className={`flex flex-col pb-[14px] justify-center items-center text-[16px] leading-[20px] font-[400] gap-[8px] mx-[8px] w-[140px] pt-[16px] relative ${
              params === "" ? "text-primary" : "text-grey"
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              className={`text-[32px] text-black transition-all ease-in-out origin-left ${
                params === "" ? "fill-primary" : "fill-[#4b4f56]"
              }`}
            >
              <path
                fillRule="evenodd"
            ...
            <div className="relative">
              <div
                className={`absolute ${
                  params === "" ? "w-full" : "w-0"
                } transition-all origin-left ease-in-out h-[4px] bg-primary bottom-[-14px]`}
              ></div>
              Hotels & Homes
            </div>
          </Link>
          <Link
            to="/homes"
            className={`flex flex-col pb-[14px] justify-center items-center origin-left text-[16px] leading-[20px] font-[400] gap-[8px] mx-[8px] w-[140px] pt-[16px] relative ${
              params === "homes" ? "text-primary" : "text-grey"
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              className={`text-[32px] text-black transition-all origin-left ease-in-out ${
                params === "homes" ? "fill-primary" : "fill-[#4b4f56]"
              }`}
            >
              <path
                fillRule="evenodd"
          ...
          <Link
            to="/packages"
            className={`flex flex-col pb-[14px] justify-center items-center origin-left text-[16px] leading-[20px] font-[400] gap-[8px] mx-[8px] w-[140px] pt-[16px] relative ${
              params === "packages" ? "text-primary" : "text-grey"
            } transition-all ease-in-out`}
          >
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              className={`text-[32px] text-black transition-all origin-left ease-in-out ${
                params === "packages" ? "fill-primary" : "fill-[#4b4f56]"
              }`}
            >
              <path
                fillRule="evenodd"
          ...
          <Link
            to="/flights"
            className={`flex flex-col pb-[14px] justify-center items-center origin-left text-[16px] leading-[20px] font-[400] gap-[8px] mx-[8px] w-[140px] pt-[16px] relative ${
              params === "flights" ? "text-primary" : "text-grey"
            } transition-all ease-in-out`}
          >
            <svg
              width="1em"
              ...
              viewBox="0 0 24 24"
              className={`text-[32px] text-black transition-all origin-left ease-in-out ${
                params === "flights" ? "fill-primary" : "fill-[#4b4f56]"
              }`}
            >
              <path
                fillRule="evenodd"
          ...
          <Link
            to="/longstay"
            className={`flex flex-col pb-[14px] justify-center items-center origin-left text-[16px] leading-[20px] font-[400] gap-[8px] mx-[8px] w-[140px] pt-[16px] relative ${
              params === "longstay" ? "text-primary" : "text-grey"
            } transition-all ease-in-out`}
          >
            <div className="absolute top-[-10px]">
              <Tag>
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              className={`text-[32px] text-black transition-all origin-left ease-in-out ${
                params === "longstay" ? "fill-primary" : "fill-[#4b4f56]"
              }`}
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
          ...
          <Link
            to="/activity"
            className={`flex flex-col pb-[14px] justify-center items-center origin-left text-[16px] leading-[20px] font-[400] gap-[8px] mx-[8px] w-[140px] pt-[16px] relative ${
              params === "activity" ? "text-primary" : "text-grey"
            } transition-all ease-in-out`}
          >
            <div className="absolute top-[-10px]">
              <Tag>
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              className={`text-[32px] text-black transition-all origin-left ease-in-out ${
                params === "activity" ? "fill-primary" : "fill-[#4b4f56]"
              }`}
            >
